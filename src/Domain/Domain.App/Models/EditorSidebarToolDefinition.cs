...
public static class EditorToolCatalog
{
    ...
    private static IReadOnlyList<EditorToolDescriptor> CreateTwoDDescriptors()
        ...
        [
            ...
            TwoDAction(EditorSidebarAction.FlipSelectionHorizontal, "flip-horizontal", "Flip Horizontal", "Flip selected geometry horizontally in place.", null, "flip-horizontal", "2d.transform", "modify"),
            TwoDAction(EditorSidebarAction.FlipSelectionVertical, "flip-vertical", "Flip Vertical", "Flip selected geometry vertically in place.", null, "flip-vertical", "2d.transform", "modify"),
            TwoDAction(EditorSidebarAction.DuplicateSelection, "duplicate", "Duplicate", "Duplicate selected geometry with a small offset.", null, "duplicate", "2d.transform", "modify"),
