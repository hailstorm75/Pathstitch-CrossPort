...
public sealed class EditorShellCompositionTests
{
    ...
    public void HomePage_ContextualizesDropGuidanceAndConstrainsRecentProjects()
    {
        ...
        Assert.Contains("Classes=\"primary-action recent-action\"", home, StringComparison.Ordinal);
    ...
    public void TwoDLayersPanel_ExposesMergeWithBelow()
    {
        ...
        Assert.Contains("ToolTip.Tip=\"Merge with layer below\"", layers, StringComparison.Ordinal);
        ...
        Assert.Contains("ToolTip.Tip=\"Rename layer\"", layers, StringComparison.Ordinal);
        Assert.Contains("ToolTip.Tip=\"Delete layer\"", layers, StringComparison.Ordinal);
