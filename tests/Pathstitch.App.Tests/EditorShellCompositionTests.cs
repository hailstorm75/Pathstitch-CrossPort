...
public sealed class EditorShellCompositionTests
{
    ...
    public void Shell_OwnsAllEditorRegionsAndModeSwitching()
    {
        ...
        Assert.Contains("AutomationProperties.AutomationId=\"editor.right-panel\"", shell, StringComparison.Ordinal);
        Assert.Contains("Height=\"360\"", shell, StringComparison.Ordinal);
    ...
    public void HomePage_ContextualizesDropGuidanceAndConstrainsRecentProjects()
    {
        ...
        Assert.Contains("ColumnDefinitions=\"176,*\"", home, StringComparison.Ordinal);
        Assert.Contains("Width=\"210\"", home, StringComparison.Ordinal);
        Assert.Contains("<Border.ContextMenu>", home, StringComparison.Ordinal);
        Assert.Contains("Header=\"Open\"", home, StringComparison.Ordinal);
        Assert.Contains("Header=\"Reveal in Folder\"", home, StringComparison.Ordinal);
        Assert.Contains("Header=\"Remove from Recent\"", home, StringComparison.Ordinal);
        Assert.DoesNotContain("recent-action", home, StringComparison.Ordinal);
        Assert.Contains("Text=\"New Project\"", home, StringComparison.Ordinal);
        Assert.Contains("Text=\"Open File...\"", home, StringComparison.Ordinal);
    ...
    public void TwoDLayersPanel_ExposesMergeWithBelow()
    {
        ...
        Assert.Contains("Header=\"Merge with Layer Below\"", layers, StringComparison.Ordinal);
        ...
        Assert.Contains("editor.layers.delete", layers, StringComparison.Ordinal);
        Assert.Contains("OnMoveActiveLayerUpClicked", codeBehind, StringComparison.Ordinal);
        Assert.Contains("OnMoveActiveLayerDownClicked", codeBehind, StringComparison.Ordinal);
        Assert.Contains("OnAssignSelectionToActiveLayerClicked", codeBehind, StringComparison.Ordinal);
        Assert.Contains("OnDeleteActiveLayerClicked", codeBehind, StringComparison.Ordinal);
        Assert.Contains("Classes=\"layer-row\"", layers, StringComparison.Ordinal);
        Assert.Contains("Height=\"30\"", layers, StringComparison.Ordinal);
        Assert.DoesNotContain("Click=\"OnMoveLayerUpClicked\"", layers, StringComparison.Ordinal);
        Assert.DoesNotContain("Click=\"OnMoveLayerDownClicked\"", layers, StringComparison.Ordinal);
        Assert.DoesNotContain("Click=\"OnAssignSelectionClicked\"", layers, StringComparison.Ordinal);
        Assert.DoesNotContain("Click=\"OnDeleteLayerClicked\"", layers, StringComparison.Ordinal);
        Assert.Contains("<ToggleButton", layers, StringComparison.Ordinal);
        Assert.Contains("Content=\"{Binding VisibilityGlyph}\"", layers, StringComparison.Ordinal);
        Assert.Contains("ToolTip.Tip=\"{Binding VisibilityLabel}\"", layers, StringComparison.Ordinal);
        Assert.Contains("IsChecked=\"{Binding IsVisible, Mode=OneWay}\"", layers, StringComparison.Ordinal);
        Assert.Contains("Content=\"{Binding LockGlyph}\"", layers, StringComparison.Ordinal);
        Assert.Contains("ToolTip.Tip=\"{Binding LockLabel}\"", layers, StringComparison.Ordinal);
        ...
        Assert.Contains("<Button.Flyout>", layers, StringComparison.Ordinal);
        Assert.Contains("ToolTip.Tip=\"Change layer color\"", layers, StringComparison.Ordinal);
        Assert.DoesNotContain("PlaceholderText=\"Folder (root)\"", layers, StringComparison.Ordinal);
        Assert.DoesNotContain("SelectionChanged=\"OnLayerFolderChanged\"", layers, StringComparison.Ordinal);
        ...
        Assert.Contains("ToolTip.Tip=\"Add folder\"", layers, StringComparison.Ordinal);
        ...
        Assert.Contains("ToolTip.Tip=\"Add subfolder\"", layers, StringComparison.Ordinal);
        ...
        Assert.Contains("Text=\"{Binding HierarchyGuide}\"", layers, StringComparison.Ordinal);
        Assert.Contains("drop onto a folder", layers, StringComparison.Ordinal);
